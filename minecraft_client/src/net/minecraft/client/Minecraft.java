...
import net.minecraft.src.callable.CallableClientMemoryStats;
import net.minecraft.src.callable.CallableClientProfiler;
import net.minecraft.src.callable.CallableGLInfo;
import net.minecraft.src.callable.CallableLWJGLVersion;
import net.minecraft.src.callable.CallableModded;
import net.minecraft.src.callable.CallableParticleScreenName;
import net.minecraft.src.callable.CallableTexturePack;
import net.minecraft.src.callable.CallableTickingScreenName;
import net.minecraft.src.callable.CallableType2;
import net.minecraft.src.callable.CallableUpdatingScreenName;
