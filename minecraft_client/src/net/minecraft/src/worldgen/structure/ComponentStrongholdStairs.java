...
public class ComponentStrongholdStairs extends ComponentStronghold {
	...
	public boolean addComponentParts(World var1, Random var2, StructureBoundingBox var3) {
		if(this.isLiquidInStructureBoundingBox(var1, var3)) {
			...
			this.placeBlockAtCurrentPosition(var1, Block.stoneSingleSlab.blockID, 0, 1, 6, 1, var3);
			...
			this.placeBlockAtCurrentPosition(var1, Block.stoneSingleSlab.blockID, 0, 3, 3, 1, var3);
			...
			this.placeBlockAtCurrentPosition(var1, Block.stoneSingleSlab.blockID, 0, 1, 2, 1, var3);
			this.placeBlockAtCurrentPosition(var1, Block.stoneBrick.blockID, 0, 1, 1, 2, var3);
			this.placeBlockAtCurrentPosition(var1, Block.stoneSingleSlab.blockID, 0, 1, 1, 3, var3);
			return true;
		}
	}
}
