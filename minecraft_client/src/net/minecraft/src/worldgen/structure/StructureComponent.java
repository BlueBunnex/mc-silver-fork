...
public abstract class StructureComponent {
	...
	protected int getMetadataWithOffset(int var1, int var2) {
		...
		} else if(var1 != Block.doorWood.blockID && var1 != Block.doorIron.blockID) {
			if(var1 != Block.stairsCobblestone.blockID && var1 != Block.stairsWoodOak.blockID && var1 != Block.stairsNetherBrick.blockID && var1 != Block.stairsStoneBrick.blockID && var1 != Block.stairsSandStone.blockID) {
				...
				} else if(var1 == Block.stoneButton.blockID) {
					if(this.coordBaseMode == 0) {
						if(var2 == 3) {
							return 4;
						}
				...
				} else if(var1 != Block.tripWireSource.blockID && (Block.blocksList[var1] == null || !(Block.blocksList[var1] instanceof BlockDirectional))) {
					if(var1 == Block.pistonBase.blockID || var1 == Block.pistonStickyBase.blockID || var1 == Block.lever.blockID || var1 == Block.dispenser.blockID) {
						if(this.coordBaseMode == 0) {
							if(var2 == 2 || var2 == 3) {
		...
		for(int var9 = var4; var9 <= var7; ++var9) {
			for(int var10 = var3; var10 <= var6; ++var10) {
				for(int var11 = var5; var11 <= var8; ++var11) {
					this.placeBlockAtCurrentPosition(var1, 0, 0, var10, var9, var11, var2);
				}
			}
		}
		...
		for(int var14 = var4; var14 <= var7; ++var14) {
			for(int var15 = var3; var15 <= var6; ++var15) {
				for(int var16 = var5; var16 <= var8; ++var16) {
					if(!var13 || this.getBlockIdAtCurrentPosition(var1, var15, var14, var16, var2) != 0) {
	...
	protected void clearCurrentPositionBlocksUpwards(World var1, int var2, int var3, int var4, StructureBoundingBox var5) {
		...
		if(var5.isVecInside(var6, var7, var8)) {
			while(!var1.isAirBlock(var6, var7, var8) && var7 < 255) {
				var1.setBlock(var6, var7, var8, 0, 0, 2);
				++var7;
			}
	...
	protected boolean generateStructureChestContents(World var1, StructureBoundingBox var2, Random var3, int var4, int var5, int var6, WeightedRandomChestContent[] var7, int var8) {
		...
		if(var2.isVecInside(var9, var10, var11) && var1.getBlockId(var9, var10, var11) != Block.chest.blockID) {
			var1.setBlock(var9, var10, var11, Block.chest.blockID, 0, 2);
	...
	protected boolean generateStructureDispenserContents(World var1, StructureBoundingBox var2, Random var3, int var4, int var5, int var6, int var7, WeightedRandomChestContent[] var8, int var9) {
		...
		if(var2.isVecInside(var10, var11, var12) && var1.getBlockId(var10, var11, var12) != Block.dispenser.blockID) {
			var1.setBlock(var10, var11, var12, Block.dispenser.blockID, this.getMetadataWithOffset(Block.dispenser.blockID, var7), 2);
			TileEntityDispenser var13 = (TileEntityDispenser)var1.getBlockTileEntity(var10, var11, var12);
			if(var13 != null) {
