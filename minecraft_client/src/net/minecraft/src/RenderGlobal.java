...
import net.minecraft.src.entity.EntityAuraFX;
import net.minecraft.src.entity.EntityBreakingFX;
import net.minecraft.src.entity.EntityBubbleFX;
import net.minecraft.src.entity.EntityCloudFX;
import net.minecraft.src.entity.EntityCritFX;
import net.minecraft.src.entity.EntityDiggingFX;
import net.minecraft.src.entity.EntityDropParticleFX;
import net.minecraft.src.entity.EntityEnchantmentTableParticleFX;
import net.minecraft.src.entity.EntityExplodeFX;
import net.minecraft.src.entity.EntityFX;
import net.minecraft.src.entity.EntityFireworkSparkFX;
import net.minecraft.src.entity.EntityFlameFX;
import net.minecraft.src.entity.EntityFootStepFX;
import net.minecraft.src.entity.EntityHeartFX;
import net.minecraft.src.entity.EntityHugeExplodeFX;
import net.minecraft.src.entity.EntityLargeExplodeFX;
import net.minecraft.src.entity.EntityLavaFX;
import net.minecraft.src.entity.EntityLiving;
import net.minecraft.src.entity.EntityNoteFX;
import net.minecraft.src.entity.EntityPlayer;
import net.minecraft.src.entity.EntityPortalFX;
import net.minecraft.src.entity.EntityReddustFX;
import net.minecraft.src.entity.EntityRenderer;
import net.minecraft.src.entity.EntitySmokeFX;
import net.minecraft.src.entity.EntitySnowShovelFX;
import net.minecraft.src.entity.EntitySorter;
