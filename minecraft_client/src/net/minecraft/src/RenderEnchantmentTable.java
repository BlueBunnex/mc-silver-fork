...
public class RenderEnchantmentTable extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityEnchantmentTableAt(TileEntityEnchantmentTable var1, double var2, double var4, double var6, float var8) {
		...
		this.enchantmentBook.render((Entity)null, var9, var12, var13, var14, 0.0F, 1.0F / 16.0F);
		GL11.glPopMatrix();
	}

	public void renderTileEntityAt(TileEntity var1, double var2, double var4, double var6, float var8) {
		this.renderTileEntityEnchantmentTableAt((TileEntityEnchantmentTable)var1, var2, var4, var6, var8);
	}
}
