...
import net.minecraft.src.entity.EntityCrit2FX;
...
import net.minecraft.src.entity.EntityEnderPearl;
...
import net.minecraft.src.entity.EntityLargeFireball;
...
import net.minecraft.src.entity.EntityPickupFX;
...
import net.minecraft.src.gui.GuiDownloadTerrain;
...
import net.minecraft.src.gui.GuiPlayerInfo;
import net.minecraft.src.gui.GuiScreen;
import net.minecraft.src.gui.GuiScreenDemo;
import net.minecraft.src.gui.GuiScreenDisconnectedOnline;
import net.minecraft.src.gui.GuiWinGame;
import net.minecraft.src.gui.GuiYesNo;
