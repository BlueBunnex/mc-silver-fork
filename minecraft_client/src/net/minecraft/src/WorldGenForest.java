			...
			if(!var7) {
				...
				if((var8 == Block.grass.blockID || var8 == Block.dirt.blockID) && var4 < 256 - var6 - 1) {
						...
						for(var12 = var3 - var11; var12 <= var3 + var11; ++var12) {
							...
							for(int var14 = var5 - var11; var14 <= var5 + var11; ++var14) {
								...
								if(Math.abs(var13) != var11 || Math.abs(var15) != var11 || var2.nextInt(2) != 0 && var10 != 0) {
									int var16 = var1.getBlockId(var12, var17, var14);
									if(var16 == 0 || var16 == Block.leaves.blockID) {
										this.setBlockAndMetadata(var1, var12, var17, var14, Block.leaves.blockID, 2);
									}
								}
							}
						}
					...
					for(var17 = 0; var17 < var6; ++var17) {
						var10 = var1.getBlockId(var3, var4 + var17, var5);
						if(var10 == 0 || var10 == Block.leaves.blockID) {
							this.setBlockAndMetadata(var1, var3, var4 + var17, var5, Block.wood.blockID, 2);
						}
					}
