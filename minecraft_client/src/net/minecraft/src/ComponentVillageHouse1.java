...
public class ComponentVillageHouse1 extends ComponentVillage {
	...
	public ComponentVillageHouse1(ComponentVillageStartPiece var1, int var2, Random var3, StructureBoundingBox var4, int var5) {
		super(var1, var2);
		this.coordBaseMode = var5;
		this.boundingBox = var4;
	}

	public static ComponentVillageHouse1 func_74898_a(ComponentVillageStartPiece var0, List var1, Random var2, int var3, int var4, int var5, int var6, int var7) {
		StructureBoundingBox var8 = StructureBoundingBox.getComponentToAddBoundingBox(var3, var4, var5, 0, 0, 0, 9, 9, 6, var6);
		return canVillageGoDeeper(var8) && StructureComponent.findIntersecting(var1, var8) == null ? new ComponentVillageHouse1(var0, var7, var2, var8, var6) : null;
	}
	...
	public boolean addComponentParts(World var1, Random var2, StructureBoundingBox var3) {
		...
		for(var6 = -1; var6 <= 2; ++var6) {
			for(var7 = 0; var7 <= 8; ++var7) {
				this.placeBlockAtCurrentPosition(var1, Block.stairsWoodOak.blockID, var4, var7, 6 + var6, var6, var3);
				this.placeBlockAtCurrentPosition(var1, Block.stairsWoodOak.blockID, var5, var7, 6 + var6, 5 - var6, var3);
			}
		}
		...
		this.placeBlockAtCurrentPosition(var1, Block.stairsWoodOak.blockID, this.getMetadataWithOffset(Block.stairsWoodOak.blockID, 0), 7, 1, 3, var3);
		var6 = this.getMetadataWithOffset(Block.stairsWoodOak.blockID, 3);
		this.placeBlockAtCurrentPosition(var1, Block.stairsWoodOak.blockID, var6, 6, 1, 4, var3);
		this.placeBlockAtCurrentPosition(var1, Block.stairsWoodOak.blockID, var6, 5, 1, 4, var3);
		this.placeBlockAtCurrentPosition(var1, Block.stairsWoodOak.blockID, var6, 4, 1, 4, var3);
		this.placeBlockAtCurrentPosition(var1, Block.stairsWoodOak.blockID, var6, 3, 1, 4, var3);
