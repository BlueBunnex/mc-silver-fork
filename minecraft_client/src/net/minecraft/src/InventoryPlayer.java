...
public class InventoryPlayer implements IInventory {
	...
	public void setCurrentItem(int var1, int var2, boolean var3, boolean var4) {
		...
		if(var7 >= 0 && var7 < 9) {
			...
			if(var4 && var1 > 0) {
				...
				this.func_70439_a(Item.itemsList[var1], var2);
			}
	...
	public void func_70439_a(Item var1, int var2) {
		if(var1 != null) {
			int var3 = this.getInventorySlotContainItemAndDamage(var1.itemID, var2);
			if(var3 >= 0) {
			...
			this.mainInventory[this.currentItem] = new ItemStack(Item.itemsList[var1.itemID], 1, var2);
		}
	...
	public boolean addItemStackToInventory(ItemStack var1) {
		if(var1 == null) {
			...
			try {
				...
				var4.addCrashSection("Item ID", Integer.valueOf(var1.itemID));
				var4.addCrashSection("Item data", Integer.valueOf(var1.getItemDamage()));
				var4.addCrashSectionCallable("Item name", new CallableItemName(this, var1));
