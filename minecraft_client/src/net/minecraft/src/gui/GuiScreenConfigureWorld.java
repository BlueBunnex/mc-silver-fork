...
public class GuiScreenConfigureWorld extends GuiScreen {
	...
	public static Minecraft func_96265_a(GuiScreenConfigureWorld var0) {
		return var0.mc;
	}

	public static int func_96271_b(GuiScreenConfigureWorld var0) {
		return var0.field_96287_o;
	}

	public static int func_96274_a(GuiScreenConfigureWorld var0, int var1) {
		return var0.func_96264_a(var1);
	}

	public static int func_96269_c(GuiScreenConfigureWorld var0) {
		return var0.field_96286_n;
	}

	public static McoServer func_96266_d(GuiScreenConfigureWorld var0) {
		return var0.field_96280_b;
	}

	public static int func_96270_b(GuiScreenConfigureWorld var0, int var1) {
		return var0.field_96284_p = var1;
	}

	public static int func_96263_e(GuiScreenConfigureWorld var0) {
		return var0.field_96284_p;
	}

	public static FontRenderer func_96273_f(GuiScreenConfigureWorld var0) {
