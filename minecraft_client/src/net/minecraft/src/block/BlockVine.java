		...
		if(!var1.isRemote && var1.rand.nextInt(4) == 0) {
			...
			if(var10 == 1 && var3 < 255 && var1.isAirBlock(var2, var3 + 1, var4)) {
				...
				if(var12 > 0) {
					...
					if(var12 > 0) {
						var1.setBlock(var2, var3 + 1, var4, this.blockID, var12, 2);
					}
				}
			} else {
				int var14;
				if(var10 >= 2 && var10 <= 5 && (var9 & 1 << var11) == 0) {
					...
					if(var12 != 0 && Block.blocksList[var12] != null) {
						...
						if((var9 & 1 << var13) != 0 && this.canBePlacedOn(var1.getBlockId(var2 + Direction.offsetX[var11] + Direction.offsetX[var13], var3, var4 + Direction.offsetZ[var11] + Direction.offsetZ[var13]))) {
							var1.setBlock(var2 + Direction.offsetX[var11], var3, var4 + Direction.offsetZ[var11], this.blockID, 1 << var13, 2);
							...
							var1.setBlock(var2 + Direction.offsetX[var11], var3, var4 + Direction.offsetZ[var11], this.blockID, 1 << var14, 2);
							...
							var1.setBlock(var2 + Direction.offsetX[var11] + Direction.offsetX[var13], var3, var4 + Direction.offsetZ[var11] + Direction.offsetZ[var13], this.blockID, 1 << (var11 + 2 & 3), 2);
							...
							var1.setBlock(var2 + Direction.offsetX[var11] + Direction.offsetX[var14], var3, var4 + Direction.offsetZ[var11] + Direction.offsetZ[var14], this.blockID, 1 << (var11 + 2 & 3), 2);
						} else if(this.canBePlacedOn(var1.getBlockId(var2 + Direction.offsetX[var11], var3 + 1, var4 + Direction.offsetZ[var11]))) {
							var1.setBlock(var2 + Direction.offsetX[var11], var3, var4 + Direction.offsetZ[var11], this.blockID, 0, 2);
						}
					}
				} else if(var3 > 1) {
					...
					if(var12 == 0) {
						...
						if(var13 > 0) {
							var1.setBlock(var2, var3 - 1, var4, this.blockID, var13, 2);
						}
