...
import net.minecraft.src.entity.ModelChicken;
import net.minecraft.src.entity.ModelCow;
import net.minecraft.src.entity.ModelOcelot;
import net.minecraft.src.entity.ModelPig;
import net.minecraft.src.entity.ModelSheep1;
import net.minecraft.src.entity.ModelSheep2;
import net.minecraft.src.entity.ModelSlime;
import net.minecraft.src.entity.ModelSquid;
import net.minecraft.src.entity.ModelWolf;
