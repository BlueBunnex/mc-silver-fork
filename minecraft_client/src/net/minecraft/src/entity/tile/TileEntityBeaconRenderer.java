...
public class TileEntityBeaconRenderer extends TileEntitySpecialRenderer {
	public void renderTileEntityBeaconAt(TileEntityBeacon var1, double var2, double var4, double var6, float var8) {
		...
		if(var9 > 0.0F) {
			...
			double var18 = 0.5D + Math.cos(var14 + Math.PI * 0.75D) * var16;
			double var20 = 0.5D + Math.sin(var14 + Math.PI * 0.75D) * var16;
			double var22 = 0.5D + Math.cos(var14 + Math.PI * 0.25D) * var16;
			double var24 = 0.5D + Math.sin(var14 + Math.PI * 0.25D) * var16;
			double var26 = 0.5D + Math.cos(var14 + Math.PI * 1.25D) * var16;
			double var28 = 0.5D + Math.sin(var14 + Math.PI * 1.25D) * var16;
			double var30 = 0.5D + Math.cos(var14 + Math.PI * 1.75D) * var16;
			double var32 = 0.5D + Math.sin(var14 + Math.PI * 1.75D) * var16;
	...
	public void renderTileEntityAt(TileEntity var1, double var2, double var4, double var6, float var8) {
		this.renderTileEntityBeaconAt((TileEntityBeacon)var1, var2, var4, var6, var8);
	}
}
