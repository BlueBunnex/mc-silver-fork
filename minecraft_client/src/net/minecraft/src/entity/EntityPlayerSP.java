...
import net.minecraft.src.entity.tile.TileEntitySign;
import net.minecraft.src.gui.GuiBeacon;
import net.minecraft.src.gui.GuiBrewingStand;
import net.minecraft.src.gui.GuiChest;
import net.minecraft.src.gui.GuiCommandBlock;
import net.minecraft.src.gui.GuiCrafting;
import net.minecraft.src.gui.GuiDispenser;
import net.minecraft.src.gui.GuiEditSign;
import net.minecraft.src.gui.GuiEnchantment;
import net.minecraft.src.gui.GuiFurnace;
import net.minecraft.src.gui.GuiHopper;
import net.minecraft.src.gui.GuiMerchant;
import net.minecraft.src.gui.GuiRepair;
import net.minecraft.src.gui.GuiScreen;
import net.minecraft.src.gui.GuiScreenBook;
...
public class EntityPlayerSP extends EntityPlayer {
	...
	public EntityPlayerSP(Minecraft var1, World var2, Session var3, int var4) {
		...
		if(var3 != null && var3.username != null && var3.username.length() > 0) {
			this.skinUrl = "http://skins.minecraft.net/MinecraftSkins/" + StringUtils.stripControlCodes(var3.username) + ".png";
		}
