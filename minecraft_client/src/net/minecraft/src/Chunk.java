...
public class Chunk {
				...
				for(int var8 = 0; var8 < var5; ++var8) {
					...
					if(var9 != 0) {
						...
						if(this.storageArrays[var10] == null) {
							this.storageArrays[var10] = new ExtendedBlockStorage(var10 << 4, !var1.provider.hasNoSky);
						}
	...
	public boolean setBlockIDWithMetadata(int var1, int var2, int var3, int var4, int var5) {
		...
		if(var8 == var4 && var9 == var5) {
			...
			if(var8 != 0) {
				...
				} else if(Block.blocksList[var8] instanceof ITileEntityProvider && var8 != var4) {
			...
			if(var10.getExtBlockID(var1, var2 & 15, var3) != var4) {
				...
				if(var4 != 0) {
					...
					if(Block.blocksList[var4] instanceof ITileEntityProvider) {
						var14 = this.getChunkBlockTileEntity(var1, var2, var3);
						if(var14 == null) {
							var14 = ((ITileEntityProvider)Block.blocksList[var4]).createNewTileEntity(this.worldObj);
	...
	public void addEntity(Entity var1) {
		...
		if(var2 != this.xPosition || var3 != this.zPosition) {
			this.worldObj.getWorldLogAgent().logSevere("Wrong location! " + var1);
			Thread.dumpStack();
		}
	...
	public void setChunkBlockTileEntity(int var1, int var2, int var3, TileEntity var4) {
		...
		if(this.getBlockID(var1, var2, var3) != 0 && Block.blocksList[this.getBlockID(var1, var2, var3)] instanceof ITileEntityProvider) {
